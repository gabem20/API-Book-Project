...
api_description = """
This API provides read-only access to inform from the SportsWorldCentral(SWC) 
Fantasy Football API.
The endpoints are grouped into the following categories:

## Analytics
Get information about the health of the API and the counts of leagues, teams,
and players.
...
def read_players(skip: int = Query(0, description = "The number of items to skip at the beginning of the API call."),
